      ...
      <nav className="tab-bar flex border-b-2 border-gray-200 mb-4">
        <button
          className={`tab-item px-4 py-2 ${
            activeTab === "CSVUploader"
              ? "border-b-2 border-electricblue text-electricblue font-semibold"
              : "text-gray-600"
          }`}
...
export default T2DataIngestion;
