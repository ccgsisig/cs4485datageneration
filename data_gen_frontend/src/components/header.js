          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 md:gap-0 md:py-4">
            <div className="relative z-20 flex w-full justify-between md:px-0 lg:w-max">
              ...
              >
                ...
                <span className="text-2xl font-medium text-electricblue dark:text-white">
                  MomentoData
                </span>
              </a>
              <div className="relative flex max-h-10 items-center lg:hidden">
                ...
                >
                  <div
                    aria-hidden="true"
                    className="m-auto h-0.5 w-5 rounded bg-white transition duration-300 dark:bg-white"
                  ></div>
                  <div
                    aria-hidden="true"
                    className="m-auto mt-2 h-0.5 w-5 rounded bg-white transition duration-300 dark:bg-white"
                  ></div>
                </button>
              </div>
            </div>
                ...
                <ul className="flex flex-col gap-6 tracking-wide lg:flex-row lg:gap-0 lg:text-sm">
                  {links.map((link) => (
                    <li key={link.label}>
                      <Link
                        to={link.to}
                        className="hover:text-electricblue block transition dark:hover:text-white md:px-4"
                      >
                        <span className="text-charcoal">{link.label}</span>{" "}
                        {/* Added electricblue class */}
                      </Link>
                    </li>
                  ))}
                </ul>
